...
\caption{The CAT workspace. Channels and agents are listed in the sidebar, with
people grouped by discipline beneath them. The badge under the member's own name
indicates permission to invoke agents.}
\label{fig:interface}
\end{figure}
...
geospatial analyst, and so on. Each channel additionally maps specialties to
