...
and what it cost; the composer names the agents available to summon. Shown in
the dark theme, and captured before \texttt{\#general} and the theme control
were added; the layout is otherwise current.}
\label{fig:interface}
\end{figure}
