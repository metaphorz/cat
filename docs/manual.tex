...
\midrule
\texttt{/model} & Lists what each agent is running. With a search term, lists
matching models with context length and price. With an agent and a model
identifier, switches that agent's default.\\
