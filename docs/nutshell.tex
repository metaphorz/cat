...
cost far more than it saved. Code changes are made in a local editor session
instead, with Paul watching the work as it happens, so nothing reaches the main
branch without a person directing it.

So ask an agent here anything you like \emph{about} the code---how something
works, where your discipline should look first, whether an approach is
sound---and take a change you want made to Paul.
